        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories ps" id="accordionExample">
                    <li class="menu">
                        <a href="{{ route('Department') }}" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                         ...
                         <ul class="collapse submenu list-unstyled" id="dashboard2" data-parent="#accordionExample">
                            ...
                            @if($d->id!=1) 
                             <li>
                            <a href="{{ route('Employee', $d->id)}}">موظفين قسم  {{ $d->name }}  </a>
                            </li>
                            @endif
                          @endforeach 
                         </ul>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled"  id="dashboard5" data-parent="#accordionExample">
                            <li>
                                <a href="{{ route('AllReport') }}">استعراض جميع المعاملات  </a>
                            </li>
