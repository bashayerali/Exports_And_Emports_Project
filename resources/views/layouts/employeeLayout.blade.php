                        ...
                        <div class="user-profile-section">                            
                            <div class="media mx-auto">
                                <div class="media-body">
                                    <h5 name="userName">{{Auth::user()->name}}</h5> <!-- مثال -->
                                    <p name="jobTitle">{{Auth::user()->d->name}} </p> <!-- مثال -->
                                </div>
                            </div>
                        </div>
                ...
                <ul class="navbar-nav theme-brand flex-row  text-center">
                    <li class="nav-item theme-logo">
                        <a href="{{route('AdminDashboard')}}">
                            <img src="assets/img/eximport.svg" class="navbar-logo" alt="logo">
                        </a>
                    </li>
                    <li class="nav-item theme-text">
                        <a href="{{route('AdminDashboard')}}" class="nav-link"> eximpo </a>
                    </li>
                </ul>
                ...
                <li class="menu">
                     ...
                     <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled"  id="dashboard3" data-parent="#accordionExample">
                            <li>
                                <a href="{{ route('Export') }}">إضافة معاملة صادرة </a>
                            </li>
                     ...
                     <li class="menu">
                        <a href="#dashboard4" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trending-down"><polyline points="23 18 13.5 8.5 8.5 13.5 1 6"></polyline><polyline points="17 18 23 18 23 12"></polyline></svg><span>الواردات</span>
                            </div>
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg>
                            </div>
                        ...
                        <ul class="collapse submenu list-unstyled"  id="dashboard4" data-parent="#accordionExample">
                            <li>
                                <a href="{{ route('Import') }}">استعراض المعاملات الواردة  </a>
                            </li>
                    ...
                    <li class="menu">
                        <a href="#dashboard5" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-layers"><polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline><polyline points="2 12 12 17 22 12"></polyline></svg>                                <span>التقارير</span>
                            </div>
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg>
                            </div>
                        ...
                        <ul class="collapse submenu list-unstyled"  id="dashboard5" data-parent="#accordionExample">
                             <li>
                                <a href="{{route('ExportReport')}}">الصادرة</a>
                            </li>
                            <li>
                                <a href="{{route('ImportReport')}}">الواردة</a>
                            </li>
